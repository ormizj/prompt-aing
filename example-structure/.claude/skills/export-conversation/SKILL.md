...
description: Export the current Claude Code conversation to an Excel (.xlsx) file with columns for Prompt, Summary, and Output. Use when user asks to export, save, or document the conversation. Requires Python with openpyxl.
